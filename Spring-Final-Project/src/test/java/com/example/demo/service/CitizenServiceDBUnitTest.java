...
public class CitizenServiceDBUnitTest {
	...
	@Test
	void testGetAll() {
		List<Citizen> testCitizens = List.of(new Citizen("1","Rob","Fletcher","2 Grange Close", LocalDate.of(2000, 05, 30),"Shrewsbury","Male"));
	...
	void testGetByFirstName() {
		...
		assertThat(this.service.getByCitizenFirstName(search)).isEqualTo(testCitizens);
	...
	void testGetByLastName() {
		...
		assertThat(this.service.getByCitizenLastName(search)).isEqualTo(testCitizens);
	...
	void testGetByGender() {
		...
		Mockito.when(this.repo.findByGender(search)).thenReturn(testCitizens);
		
		assertThat(this.service.getByCitizenGender(search)).isEqualTo(testCitizens);
		
		Mockito.verify(this.repo, Mockito.times(1)).findByGender(search);
	...
	void testGetByID() {
		...
		Citizen testCitizen = new Citizen(search,"Rob","Fletcher","2 Grange Close", LocalDate.of(2000, 05, 30),"Shrewsbury","Male");
